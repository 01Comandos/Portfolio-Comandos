...
const Projects = ({
  ...
  <section className={`${styles.container} padding-x`}>
    ...
    {showDescription && <p className={styles.description}>
    ...
    <div className={styles.projects}>
      {projectsList.map((project, index) => (
        <div className={showAllProjects ? styles.project : `${styles.project} ${styles.projectVisibility}`} key={index}>
          <Project
            isMobile={isMobile}
            name={project.name}
    ...
    {showNavigationButton && <div className={styles.options}>
      <Link
        href="/projects"
